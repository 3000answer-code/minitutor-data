...
class _NoticeScreenState extends State<NoticeScreen>
  ...
  final List<NoticeItem> _notices = [
    NoticeItem(
      ...
      title: '🎉 2공 앱 정식 출시 안내',
      content:
          '안녕하세요, 2공입니다!\n\n공만세에서 새롭게 리뉴얼된 2공 앱이 드디어 정식 출시되었습니다.\n\n2공은 "2분 공부"의 줄임말로, 바쁜 일상 속에서도 하루 단 2분으로 핵심 개념을 이해할 수 있도록 설계된 학습 플랫폼입니다.\n\n주요 변경사항:\n• 전면 리뉴얼된 UI/UX\n• 2분 핵심 강의 전면 도입\n• 노트 필기 기능 강화\n• 전문가 상담 시스템 개선\n\n더 나은 학습 경험을 위해 최선을 다하겠습니다. 감사합니다!',
