...
class ContentService {
  ...
  List<SavedNote> getSavedNotes() => [
    ...
    SavedNote(id: 'note_002', lectureId: 'eng_001', lectureTitle: '현재완료 vs 과거시제 완벽 구분',
      subject: '영어', savedAt: '2024-11-18 10:15', previewText: 'have+p.p. = 과거~현재 연결, 과거시제 = 완전히 끝난 일', strokeCount: 8),
    SavedNote(id: 'note_003', lectureId: 'kor_002', lectureTitle: '시의 표현기법 총정리',
      subject: '국어', savedAt: '2024-11-15 16:45', previewText: '직유(~처럼), 은유(A는 B다), 의인(사물→사람)', strokeCount: 15),
  ...
  List<ScheduleEvent> getScheduleEvents() {
    ...
    return [
      ...
      ScheduleEvent(id: 'sch_002', title: '영어 문법 시리즈 3편 시청', content: '관계대명사 강의 보기',
      ...
      ScheduleEvent(id: 'sch_003', title: '2공 퀴즈 이벤트', content: '수학·과학 퀴즈 대회 참여하고 경품 받아가세요!',
      ...
      ScheduleEvent(id: 'sch_005', title: '2공 신규 강의 오픈', content: '고등 물리 시리즈 전편 업데이트!',
  ...
  List<Notice> getNotices() => [
    Notice(id: 'not_001', title: '[공지] 2공 앱 버전 2.0 업데이트 안내',
      content: '2공 앱이 새롭게 업데이트 되었습니다.\n\n✅ 주요 변경사항\n- 강의 재생 속도 조절 기능 개선\n- 노트 필기 3색 펜 추가\n- 나의 일정 달력 기능 추가\n- 전반적인 성능 최적화\n\n더 편리해진 2공으로 2분 공부를 시작해보세요!',
  ...
  List<FaqItem> getFaqItems() => [
    FaqItem(id: 'faq_001', category: '이용방법',
      question: '2공 앱은 어떻게 사용하나요?',
      answer: '2공은 2분 내외의 짧은 강의 영상으로 공부하는 앱입니다.\n\n① 홈에서 원하는 강의를 선택하세요\n② 영상을 시청하며 노트에 필기하세요\n③ 진도학습에서 학습 현황을 확인하세요\n④ 모르는 내용은 전문가 상담을 활용하세요'),
